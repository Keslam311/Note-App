...
import com.example.agenda.presentation.view.AgendaDetailsScreen
import com.example.agenda.presentation.viewModel.AgendaViewModel
import com.example.agenda.util.SwipeToDeleteContainer

@Composable
fun HomeScreenContent(noteViewModel: AgendaViewModel, darkTheme: Boolean) {
